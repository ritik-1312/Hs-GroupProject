                    ...
                    <div class="c21559276">
                        ...
                        <div class="input-wrapper _input-wrapper">
                          <div class="c1552b97d c305d5b0c text c4615ca9f cfe1de4da" data-action-text="" data-alternate-action-text="">
                            ...
                            <input class="input cb739a8a3 c95effeb5" inputmode="email" name="username" id="username" type="text" value="" required="" autocomplete="username" autocapitalize="none" spellcheck="false" autofocus="">
