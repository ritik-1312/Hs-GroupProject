                        ...
                        <div class="swiper mySwiper">
                                <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                                <img src="assets/img/home/gal.jpg" alt="" class="home-img">

                                                <div class="home-details">
                                                        <div class="home-text">
                                                                
                                                                <h2 class="homeTitle">Our Achievement</h2>
                                                                <h4 class="homeSubtitle">We are team that develop students and create their<br> future bright and fill them with knowledge.</h4>
                                                        </div>
